...
@interface NFLocalViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation NFLocalViewController
...
- (void)setupChildVc{
    ...
    NSArray *mids = @[@"1028",@"1025",@"1048",@"1049",@"1051"];
